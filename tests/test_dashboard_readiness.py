...
def receipt(event_id, stage, at, source, status="PASS", plan_id=None, reason=None):
    value = {"schema":"runtime_activity_v1","receipt_id":f"{event_id}-{stage}","event_id":event_id,"stage":stage,"status":status,"occurred_at":at,"source":source,"symbol":"MNQ"}
